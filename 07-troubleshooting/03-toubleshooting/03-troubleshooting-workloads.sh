# Login into control plane (c1-cp1)
ssh jakir@c1-cp1
...
# Failed to pull image "nginx:latest": rpc error: code = Unknown desc = Error response from daemon: manifest for psk8s.azurecr.io/hello-ap:1.0 not found
...
# Warning  FailedMount  34s  kubelet, c1-wnode3  MountVolume.SetUp failed for volume "pv-nfs-data" : mount failed: exit status 32
